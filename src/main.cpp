...
#if defined(NDEBUG)
# error "BrasilCoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x218087a3918a37a3d49920e5f0420cd3fbd7f36e25c17be197ab0e806ef0264e");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // BrasilCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BrasilCoin Signed Message:\n";
...
{
    // BrasilCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 900 * 60;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BrasilCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BrasilCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1506840314, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Defesa Civil registra problemas pontuais provocados 01102017";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0466382f17d030d22fcd80329e4640eee8cbbddf2b1accae4d5300bb4add664fcca8f30e6443b0842fe8cda10c7e8d195b857a8d22a418d4656ae65d3193471d41") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1506840314;
        ...
        assert(block.hashMerkleRoot == uint256("0x4cfa0863e97889eb1aeb84dfc31ced0e251d671aa76b4e10378454d453569867"));
...
unsigned char pchMessageStart[4] = { 0x8c, 0x1d, 0x1f, 0x7d }; // BrasilCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BrasilCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BrasilCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static BrasilCoinMiner(CWallet *pwallet)
{
    printf("BrasilCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("brasilcoin-miner");
    ...
    try { loop {
        ...
        printf("Running BrasilCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BrasilCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&BrasilCoinMiner, pwallet));
}
